...
wp-cli.phar core install --url="baarif.42.fr" --title=inception --admin_user=boss --admin_password=boss123 --admin_email=admin@gmail.com --path=/var/www/inception/htdocs/wordpress --allow-root
